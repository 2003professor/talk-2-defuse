...
function applyRedactions() {
  ...
  const safeWords = ['cut','press','hold','wire','button','red','blue','yellow','green','white','black','orange','purple',
    ...
    'about','after','again','below','brain','could','crane','every','eight','first',
    'found','great','guard','house','heart','large','learn','never','night','other',
    'orbit','place','plant','point','right','round','small','sound','spell','still',
    'study','their','there','these','thing','think','three','water','where','which',
    'world','would','write',
